...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        if (!jobDescription || !jobDescription.trim()) {
            alert("Job Description is required to generate an interview strategy.")
            return
        }

        const resumeFile = resumeInputRef.current?.files?.[ 0 ]
        if (!resumeFile && (!selfDescription || !selfDescription.trim())) {
            alert("Please either upload a Resume or provide a Quick Self-Description to give the AI context on your profile.")
            return
        }
                    ...
                    <div className='panel panel--right'>
                        <div className='panel__header'>
                            <div className='profile-dropdown-wrapper' ref={dropdownRef}>
                                <button 
                                    className='panel__icon panel__icon--button'
                                ...
                                {profileDropdownOpen && user && (
                                    <div className='profile-dropdown-menu'>
                                        <div className='dropdown-header'>
                                            <span className='dropdown-label'>Logged in as</span>
